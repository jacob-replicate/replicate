EXAMPLE_EMAILS = [
  {
    ...
    prompt: "A junior shipped an N+1 query that took down production for 6 minutes. We didn't have automation to catch it during PR review."
  },
  {
    to: "Casey Patel",
    ...
    prompt: "We launched a new authentication flow without feature gating it, causing SSO to fail in production."
  },
  {
    to: "Taylor Morales",
    ...
    prompt: "A late-night hotfix broke an invoicing job, and the rollback left customer data in a corrupted state."
  }
]
...
const SecurityPage = () => {
  return (
    <div className="h-full overflow-y-auto bg-white dark:bg-zinc-950">
      <div className="max-w-3xl mx-auto py-12 px-6 text-[15px] leading-relaxed text-zinc-700 dark:text-zinc-300">

        {/* Architecture */}
        <section className="mb-10">
          <h2 className="text-lg font-medium mb-3 text-zinc-900 dark:text-zinc-100">
            Architecture
          </h2>

          <p className="mb-4">
            All infra is provisioned/managed by <span className="font-medium text-zinc-900 dark:text-zinc-100">Heroku</span> (in <span className="font-medium text-zinc-900 dark:text-zinc-100">US-based</span> AWS regions), and uses their HA failover. Data is encrypted at rest using AES-256, and TLS 1.2+ in transit. The tool is ephemeral, and wipes data older than 3 months.
          </p>

          <div className="mt-5">
            <h3 className="font-medium mb-1 text-zinc-900 dark:text-zinc-100">Automated Dependency Scanning</h3>
            <p>
          ...
          <div className="mt-5">
            <h3 className="font-medium mb-1 text-zinc-900 dark:text-zinc-100">Cookie Policy</h3>
            <p>
          ...
          <div className="mt-5">
            <h3 className="font-medium mb-1 text-zinc-900 dark:text-zinc-100">Database Backups</h3>
            <p>
              <a
        ...
        <section>
          ...
          <div className="space-y-5">
            <div>
              <h3 className="font-medium text-zinc-900 dark:text-zinc-100">Amazon S3</h3>
              <p>Stores immutable, append-only audits for admin actions (e.g., data removal) with AES-256 at rest.</p>
            </div>

            <div>
              <h3 className="font-medium text-zinc-900 dark:text-zinc-100">Datadog</h3>
              <p>Used for infrastructure telemetry and monitoring (e.g., CPU, memory, service health).</p>
            </div>

            <div>
              <h3 className="font-medium text-zinc-900 dark:text-zinc-100">Heroku</h3>
              <p>
            ...
            <div>
              <h3 className="font-medium text-zinc-900 dark:text-zinc-100">OpenAI</h3>
              <p>
            ...
            <div>
              <h3 className="font-medium text-zinc-900 dark:text-zinc-100">PagerDuty</h3>
              <p>
            ...
            <div>
              <h3 className="font-medium text-zinc-900 dark:text-zinc-100">Papertrail</h3>
              <p>
            ...
            <div>
              <h3 className="font-medium text-zinc-900 dark:text-zinc-100">Sentry</h3>
              <p>

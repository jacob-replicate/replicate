...
const ChannelSwitcher = ({
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-zinc-950 overflow-hidden text-sm h-full w-full relative">
      {/* Training mode banner - full width */}
      {!bannerDismissed && (
      ...
      <div className="flex-shrink-0 flex items-center justify-between px-4 py-2 border-b border-zinc-800 bg-zinc-900">
        <div className="flex items-center gap-2">
          ...
          {/* Wordmark */}
          <span className="font-semibold text-zinc-100 text-[15px] tracking-tight">invariant<span className="text-zinc-500">.training</span></span>
        </div>
        <div className="flex items-center gap-6">
          {/* Navigation links */}
          <nav className="hidden md:flex items-center gap-4 text-[13px] text-zinc-400">
            ...
            <a href="/privacy" className="hover:text-zinc-100 transition-colors">Privacy</a>
            <a href="/terms" className="hover:text-zinc-100 transition-colors">Terms</a>
          </nav>
